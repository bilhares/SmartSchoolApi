...
namespace SmartSchoolWebApi.Data
{
    public class DataContext:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("data source=localhost\\SQLEXPRESS;initial catalog=SMART_SCHOOL;persist security info=True;user id=sa;password=root;MultipleActiveResultSets=True;App=EntityFramework");
        }

        protected override void OnModelCreating(ModelBuilder builder)
        {
            //somente em casos de muito para muitos
